...
<form name="login-form" class="login-form" method="post" action="register.php">
	...
	<input onclick="this.value=''; this.type='password';" name="pass_word" type="text" id="password"value="Wpisz haslo" class="testresult input username"/>
    <!--haslo2--><input onclick="this.value=''; this.type='password';" name="password2" type="text" class="input username" value="Powtórz haslo" onfocus="this.value=''" />
	...
	<!--captcha_code--><input name="captcha_code" type="text" class="input username" value="Przepisz kod z obrazka:" onfocus="this.value=''" />
